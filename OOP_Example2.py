...
# Abstart class = a class which contains one or more abstract methods
...
class Engine(Car):
    ...
    def show_car_details(self):        #Example of method overiding from 'Car CLASS'
        print(self.model, "The engine detail is not available")
...
c2.setPower(1000)
#Current Engine power is set to 1000
